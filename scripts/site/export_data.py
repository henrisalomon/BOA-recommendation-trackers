...
def main():
 ...
 gaptexts=[
  ...
  'Entities are matched conservatively to the supplied Entity/Office list. Original wording is retained. Unmatched names require review; no historical successor is inferred. Joint means more than one distinct parent entity; offices within one parent count as Individual. Incomplete single-entity matches remain Unknown. Entity breakdowns overlap for joint recommendations; their counts must not be added. Trend comparisons hold selected-year entity and responsibility attribution fixed.',
