...
- `data/snapshots.json`: annual audit-year register states, assessment populations, entity source wording and selected BOA history IDs. 2014 is the opening baseline; 2015–2025 are display years. Volume I 2025 includes BOA assessments and issuance; its corresponding SG report was not located as of 24 September 2026. Volume II 2024–25 includes BOA and SG reports.
...
## Historical SG recovery — 24 September 2026

Twelve older Volume I recommendations now have source-backed responsible entities, targets and SG statuses. A/70/338 was added as targeted follow-up for these twelve identities, with its corrigendum retained and reviewed (none of its corrections changes these entries). The extractor now recognizes “As indicated in paragraph…” and stops the preceding entry at that boundary. Six skipped updates from A/71/331/Add.2 were recovered, including three of the twelve formerly missing identities. The recommendation population and BOA assessments are unchanged. A/81/5 (Vol. I) still has no corresponding SG source in the collection. See `outputs/boa-2015-2024/SG_RECOVERY.md` for the per-recommendation audit trail.
